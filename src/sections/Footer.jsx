...
const Footer = () => {
  return (
    <footer className="max-container">
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
          {footerLinks.map((section) => (
            <div key={section.title}>
              ...
              mb-6 text-white">{section.title}</h4>
              <ul>
                {section.links.map((link) => (
                  <li className="mt-3 font-montserrat text-base leading-normal text-white-400
      ...
      max-sm:items-center">
        <div className="flex flex-1 justify-start items-center gaap-2 font-montserrat cursor-pointer">
          <img 
            src={copyrightSign}
            alt="copyright sign"
            width={20}
